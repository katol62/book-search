...
class Listeners {
    ...
    class func build(json:JSON) -> Listeners? {
        let listeners : Listeners = Listeners()
        listeners.listeners = json["listeners"] != JSON.null ? json["listeners"].intValue : 0
        listeners.donates = json["donates"] != JSON.null ? json["donates"].intValue : 0
        listeners.purchases = json["purchases"] != JSON.null ? json["purchases"].intValue : 0
        listeners.subscribers = json["subscribers"] != JSON.null ? json["subscribers"].intValue : 0
        listeners.token = json["subscribers"] != JSON.null ? json["subscribers"].intValue : 0
        listeners.available = json["subscribers"] != JSON.null ? json["subscribers"].intValue : 0
        listeners.hidden = json["hidden"] != JSON.null ? json["hidden"].boolValue : false
        return listeners
    }
...
class ZoneObject {
    ...
    init() {
        self.utc_offset = String()
        self.state_abbr = String()
        self.zone_abbr = String()
        self.zone_name = String()
        self.zone_id = String()
    }
    
    class func build(json:JSON) -> ZoneObject? {
        
        let zone : ZoneObject = ZoneObject()
        zone.utc_offset = json["utc_offset"].string != nil ? json["utc_offset"].string : ""
        zone.state_abbr = json["state_abbr"].string != nil ? json["state_abbr"].string : ""
        zone.zone_abbr = json["zone_abbr"].string != nil ? json["zone_abbr"].string : ""
        zone.zone_name = json["zone_name"].string != nil ? json["zone_name"].string : ""
        zone.zone_id = json["zone_id"].string != nil ? json["zone_id"].string : ""
...
class StateObject {
    ...
    init() {
        ...
        self.state_abbr = String()
        self.zones = [ZoneObject]()
    }

    class func build(json:JSON) -> StateObject? {
        
        let state : StateObject = StateObject()
        state.country = json["country"].string != nil ? json["country"].string : "US"
        state.state_name = json["state_name"].string != nil ? json["state_name"].string : ""
        state.state_abbr = json["state_abbr"].string != nil ? json["state_abbr"].string : ""
        state.zones = [ZoneObject]()
        if json["zones"].array != nil {
            for zone in json["zones"].arrayValue {
                let zoneObj : ZoneObject = ZoneObject.build(json: zone)!
                state.zones.append(zoneObj)
            }
        }
        return state
    }
