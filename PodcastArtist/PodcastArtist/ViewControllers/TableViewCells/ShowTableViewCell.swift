...
//  PodcastArtist
//
//  Created by apple on 09.11.2019.
...
class ShowTableViewCell: UITableViewCell {
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        ...
        self.contentView.backgroundColor = selected ? colorMenuSelectedSemitransparent : .clear
    }

    override func setHighlighted(_ highlighted: Bool, animated: Bool) {
        self.contentView.backgroundColor = highlighted ? colorMenuSelectedSemitransparent : .clear
    }
}
