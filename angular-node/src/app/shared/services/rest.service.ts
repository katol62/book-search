...
import {IBaseRequest, IBaseResponse} from '../../../../server/interfaces/http-data';
...
export class RestService {
  ...
  protected postForm<I extends IBaseRequest, O extends IBaseResponse>(url: string, data?: I, headers?: HttpHeaders): Observable<O> {
  ...
  private handleError(error: HttpErrorResponse | any): Observable<any> {
    ...
    const message: IMessageItem = {message: text, messageCode: error.status, messageType: NotificationMessageType.error};
