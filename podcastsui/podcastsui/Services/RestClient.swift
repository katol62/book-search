...
class RestClient: NSObject {
    ...
    func get(serviceName:String,parameters: [String:Any]?, completionHandler: @escaping (JSON?, NSError?) -> ()) {
    ...
    func post(serviceName:String,parameters: [String:Any]?, completionHandler: @escaping (JSON?, NSError?) -> ()) {
    ...
    func postMultiPart (serviceName:String, parameters:NSDictionary?, arrayImagesData:NSArray?, arrayFileNames: NSArray?, completionHandler: @escaping (JSON?, NSError?) -> ()){
